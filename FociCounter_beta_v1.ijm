...
PURPOSE:
This macro is intended to allow fully reproducible quantification of foci inside mitochondria from fluorescence images of (mammalian) cell culture.
...
TODOs = newArray("Convert to Tiff", "Find Cells", "Find Foci", "Co-localise Foci");	// define list of options
...
Dialog.addString("What date is it today?", "20240101");								// ask for date to label output files
